...
| [`audio_protocols.py`](audio_protocols.py), [`visual_protocols.py`](visual_protocols.py), [`audio_protocols_explicit.py`](audio_protocols_explicit.py), [`visual_protocols_explicit.py`](visual_protocols_explicit.py)| Functions for running tasks |
| [`instructions_production.tsv`](instructions_production.tsv), [`instructions_perception.tsv`](instructions_perception.tsv), [`instructions_notemporal.tsv`](instructions_notemporal.tsv), [`instructions_notemporal_withrandom.tsv`](instructions_notemporal_withrandom.tsv),[`instructions_production_explicit.tsv`](instructions_production_explicit.tsv),[`instructions_perception_explicit.tsv`](instructions_perception_explicit.tsv), [`instructions_notemporal_explicit.tsv`](instructions_notemporal_explicit.tsv), [`instructions_notemporal_withrandom_explicit.tsv`](instructions_notemporal_withrandom_explicit.tsv) | Instruction texts|
| [`menu_config.ini`](menu_config.ini), [`instructions_config.ini`](instructions_config.ini), [`trainsess_config.ini`](trainsess_config.ini), [`behavsess_config.ini`](behavsess_config.ini), [`imagingsess_config.ini`](imagingsess_config.ini), [`pc1.ini`](pc1.ini), [`pc2.ini`](pc2.ini) | Configuration files |
| [`confparser.py`](confparser.py), [`instructions.py`](instructions.py), [`utils.py`](utils.py), [`sessrun_numbers.py`](sessrun_numbers.py) | Helper files |
