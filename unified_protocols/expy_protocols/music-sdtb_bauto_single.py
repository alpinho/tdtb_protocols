...
# python music-sdtb_bauto_single.py <pc_type> <subject_number> <session_number> <line_number_from_session_plan>
# Example:
# python music-sdtb_bauto_single.py win 48 1 7
# ======================================================================
...
# Run only the requested protocol line, then return to the calling script.
sessplan = sessplan[line-1:line]
